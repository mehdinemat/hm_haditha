    ...
    <Container maxW="1150px" padding={0}>
      ...
      <Box height={'100vh'} as={VStack} mt={'100px'}>
        ...
        `,
          ...
          <HStack>
            <IoArrowForward style={{ backgroundColor: 'white', borderRadius: '10px' }} />
            <Text>حدیث 15</Text>
            <IoArrowBack style={{ backgroundColor: 'white', borderRadius: '10px' }} />
          </HStack>
        ...
        <VStack w={'100%'} gap={'30px'} alignItems={'start'} mt={'40px'}>
